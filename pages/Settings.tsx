...
const Settings: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto animate-enter w-full">
        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-sm text-slate-500 mb-4 leading-relaxed">
                    ...
                    <br/><span className="text-xs text-orange-500 block mt-1">注意：Key 將儲存在您的瀏覽器本地端 (LocalStorage)，不會上傳至我們的主機。</span>
                </p>

                {savedKey ? (
                    <div className="flex flex-col md:flex-row md:items-center gap-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <div className="flex-1 font-mono text-slate-500 text-sm break-all">
                            {savedKey.substring(0, 8)}*************************
                        </div>
                        <button 
                            onClick={handleRemove}
                            className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-red-200 text-red-600 hover:bg-red-50 rounded-lg font-medium transition-colors text-sm shadow-sm"
                        >
                    ...
                    <div className="flex flex-col md:flex-row gap-3">
                        <input 
                            ...
                            className="w-full flex-1 border border-gray-300 rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
                            value={apiKey}
                        ...
                        <button 
                            ...
                            className="w-full md:w-auto bg-indigo-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-indigo-700 disabled:bg-indigo-300 transition-colors flex items-center justify-center gap-2 shrink-0"
                        >
                            <Save size={18} /> 儲存
                        </button>
                    </div>
